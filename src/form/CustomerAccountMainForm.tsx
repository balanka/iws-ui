...
export const CustomerAccountMainForm = ({
  ...
  return (
    <CInputGroup  style={{...styles.outer}} >
      ...
      <FormRow1Col label={t('common.offsetAccount')} field={<FormMasterfileXComboBox fieldName="oaccount" current={current} setCurrent={setCurrent} data={accData} defaultValue={initAcc[0]} zIndex={11} disable={disable} styles={s} fontSize={12} />} {...cw} rowHeight="32px" gap="4px" />
