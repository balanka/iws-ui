...
export  const StoreTabs =(
    {current, setCurrent, accData, locale,  t,  disable, height, zIndex }:StoreProps) => {
    const  props:StoreProps = { current, setCurrent, accData, locale,  t,  disable, height, zIndex }
    const  props2:StoreGeneralFormProps = { current, setCurrent, accData, locale,  t,  disable, height }
  ...
  const getTable = () =>
    <Grid container
      ...
      <StockGrid
          // @ts-ignore
          theme="legacy" columnDefs ={stockColumnDefs(t)}  //defaultColDef={defaultColDef}
