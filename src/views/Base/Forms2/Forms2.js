...
import MasterfileForm2 from '../Components/MasterfileForm2'
                ...
                <Row>
                  <Col xs="12">
                    <FormGroup>
                      ...
                      <Input type="text" id="nachname" placeholder="Enter your nachname" required />
                    </FormGroup>
                  </Col>
                </Row>
                <Row>
                ...
                <Row>
                  <Col xs="4">
                    <FormGroup>
                      ...
                      <Input type="select" name="ccmonth" id="ccmonth" value="12">
                  ...
                  <Col xs="4">
                    <FormGroup>
                      ...
                      <Input type="select" name="ccyear" id="ccyear" value="2026">
                        <option>2017</option>
                        <option>2018</option>
                        <option>2019</option>
                        <option>2020</option>
            ...
            <Card>
              ...
              <CardBody>
                ...
                <FormGroup row className="my-0">
                  ...
                  <Col xs="4">
                    <FormGroup>
                      <Label htmlFor="postal-code2">Postal Code2</Label>
                      <Input type="text" id="postal-code2" placeholder="Postal Code2" />
                    </FormGroup>
                  </Col>
                </FormGroup>
                <FormGroup>
            ...
            <Card>
              ...
              <CardBody>
                <Form action="" method="post" className="form-horizontal">
                  <FormGroup row>
                    <Col sm="2">
                      <Label htmlFor="input-small">Small Input3</Label>
                    </Col>
                    <Col sm="3">
                      <Input type="text" placeholder=".col-sm-3" />
                    </Col>
                    <Col sm="2">
                      <Label htmlFor="input-small">Small Input31</Label>
                    </Col>
                    <Col sm="3">
                      <Input type="text" placeholder=".col-sm-31" />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col sm="2">
                      <Label htmlFor="input-small">Small Input4</Label>
                    </Col>
                    <Col sm="3">
                  ...
                  <FormGroup row>
                    <Col sm="2">
                      <Label htmlFor="input-small">Small Input5</Label>
                    </Col>
                    <Col sm="3">
                  ...
                  <FormGroup row>
                    <Col sm="2">
                      <Label htmlFor="input-small">Small Input6</Label>
                    </Col>
                    <Col sm="3">
