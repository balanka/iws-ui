    ...
    const buildForm = () =>
            <Grid container spacing={2} style={{...styles.outer}} direction='column'>
                ...
                <FormFactory formid={formEnum.BALANCETREE} current={current} setCurrent={setCurrent} t={t} accData={accData}
                             collapse={state.collapse} height = {35} styles={styles} submitQuery={submitQuery_}/>
...
const  BasicTreeTable = ()=> {
    ...
    return Internal(data, setData, accUrl, initAcc, accData_, setAccData, token, navigate, current?current:current_, initialState
