...
const COSTCENTER =(t)=>({id:"6", name:'CostCenter', title:t('costcenter.title'), ctx:"/cc/1000", ctx1:"/acc/1000", ctx2:'/', ctx3:'', get:"md/6"
    , form:masterfilesForm, state:initCC, state1:initAcc ,state2:'', state3:'', modelid:formEnum.COSTCENTER, columns:ColumnsM(initAcc, t)})
const ACCOUNT =(t)=>({id:"9", name:"Account", title:t('account.title'), ctx:"/acc/1000", ctx1:"", ctx2:'', ctx3:'', get:"md/9"
    , form:masterfilesForm, state:initCC, state1:initAcc ,state2:'', state3:'', modelid:formEnum.ACCOUNT, columns:ColumnsACC(initAcc, t)})
...
const BANK =(t)=>({id:"11", name:"Bank", title:t('bank.title'), ctx:"/bank/1000", ctx1:"", ctx2:"", ctx3:'', get:"md/11"
    , form:masterfilesForm, state:initBank, state1:initAcc ,state2:'', state3:'', modelid:formEnum.BANK, columns:ColumnsM(initAcc, t)})
const VAT =(t)=>({id:"14", name:"Vat", title:t('vat.title'), ctx:"/vat/1000", ctx1:"/acc/1000", ctx2:"", ctx3:'', get:"md/14"
    , form:masterfilesForm, state:initVat, state1:initAcc ,state2:'', state3:'', modelid:formEnum.VAT, columns:ColumnsVAT(initAcc, t)})
...
export const modules  = (t) =>[
      ...
      , {id:"1", name:"Supplier", title:t('supplier.title'), ctx:"/sup", ctx1:"/acc/accmd/9", ctx2:"/vat",  ctx3:"/bank", get:"md/1"
            , form:masterfilesForm , state:initSup, state1:initAcc ,state2:initVat, modelid:formEnum.CUSTOMER, columns:ColumnsCUST(initAcc, t)}
    , {id:"3", name:'Customer', title:t('customer.title'), ctx:"/cust", ctx1:"/acc/accmd/9", ctx2:"/vat", ctx3:"/bank", get:"md/3"
        , form:masterfilesForm , state:initCust, state1:initAcc, state2:initVat, modelid:formEnum.CUSTOMER, columns:ColumnsCUST(initAcc,t)}
    , {id:"6", name:'CostCenter', title:t('costcenter.title'), ctx:"/cc", ctx1:"/acc/accmd/9", ctx2:'/', ctx3:'', get:"md/6"
        , form:masterfilesForm, state:initCC, state1:initAcc ,state2:'', modelid:formEnum.COSTCENTER, columns:ColumnsM(initAcc, t)}
    , {id:"9", name:"Account", title:t('account.title'), ctx:"/acc", ctx1:"/acc/accmd/9", ctx2:'', ctx3:'', get:"md/9"
        , form:masterfilesForm, state:initCC, state1:initAcc ,state2:'', modelid:formEnum.ACCOUNT, columns:ColumnsACC(initAcc, t)}
    , {id:"10", name:"Company", title:t('company.title'), ctx:"/comp", ctx1:"/acc/accmd/9", ctx2:"/vat", ctx3:"/bank", get:"md/10"
        , form:masterfilesForm, state:initComp, state1:initAcc ,state2:initVat, modelid:formEnum.COMPANY, columns:ColumnsComp(initAcc,t)}
    , {id:"11", name:"Bank", title:t('bank.title'), ctx:"/bank", ctx1:"", ctx2:"", ctx3:'', get:"md/11"
        , form:masterfilesForm, state:initBank, state1:initAcc ,state2:'', modelid:formEnum.BANK, columns:ColumnsM(initAcc, t)}
    , {id:"14", name:"Vat", title:t('vat.title'), ctx:"/vat", ctx1:"/acc/accmd/9", ctx2:"", ctx3:'', get:"md/14"
        , form:masterfilesForm, state:initVat, state1:initAcc ,state2:'', modelid:formEnum.VAT, columns:ColumnsVAT(initAcc, t)}
    ...
    , {id:"111", name:"User", title:t('user.title'), ctx:"/users", ctx1:'', ctx2:"", ctx3:'', get:"md/111"
        , form:masterfilesForm, state:initUser, state1:'', state2:'', modelid:formEnum.USER, columns:ColumnsUSER(t)  }
 ...
 , {id:"1300", name:"Balancesheet", title:t('balancesheet.title'), ctx:"/balance", ctx1:"/acc", ctx2:"", ctx3:'', get:"md/112"
