...
const mapping = (acc) => (
  <MenuItem key={acc.id} value={acc.id}>
    {acc.id.concat(EMPTY_CHAR).concat(acc.name)}
  </MenuItem>
)
export const ACCOUNT = (data, value, onRowDataChange, rowData, fieldName) => {
  return (
    <Select
      value={value}
      onChange={(event) => onRowDataChange({ ...rowData, [`${fieldName}`]: event.target.value })}
    >
...
export const OACCOUNT = (data, value, onRowDataChange, rowData, fieldName) => {
  return (
    <Select
      value={value}
      onChange={(event) => onRowDataChange({ ...rowData, oaccount: event.target.value })}
    >
      {data.map(mapping)} id={'cb'.concat(fieldName)}
    </Select>
  )
...
export const columns_BANK_ACCOUNT = (data, t) => [
  {
    field: 'id',
    title: t('common.iban'),
    initialEditValue: '',
...
export const Transactioncolumns = (storeData, ccData, line, current, t, locale, currency) => [
  {
    field: 'id',
  ...
  return [
    {
      ...
      type: 'numeric',
      editComponent: (tableData) => Autocomplete(data, tableData),
      initialEditValue: line ? line.id : -1,
      align: 'left',
      minWidth: 100,
      maxWidth: 200,
      export: true,
...
export const RightsColumns = (data, line, current, t) => {
  return [
    ...
    },
    {
      ...
      type: 'numeric',
      editComponent: (tableData) => Autocomplete(data, tableData),
      initialEditValue: line ? line.moduleid : -1,
      align: 'left',
      minWidth: 100,
      maxWidth: 200,
      export: true,
...
export const Linescolumns = (data, line, current, models, model, t, locale, currency) => {
  ...
  return [
    ...
    {
      field: 'account',
      title: t('financials.line.account'),
      type: 'string',
      editComponent: (tableData) => Autocomplete(data, tableData, true),
      initialEditValue: debitedAccount,
      align: 'left',
      width: 15,
      minWidth: 10,
      maxWidth: 50,
    ...
    {
      field: 'accountName',
      title: t('financials.line.accountName'),
      initialEditValue: '',
      hidden: false,
      width: 60,
      minWidth: 30,
    ...
    {
      field: 'oaccount',
      title: t('financials.line.oaccount'),
      type: 'string',
      editComponent: (tableData) => Autocomplete(data, tableData, true),
      initialEditValue: creditedAccount,
      width: 15,
      minWidth: 10,
      maxWidth: 50,
      align: 'right',
    ...
    {
      field: 'oaccountName',
      title: t('financials.line.oaccountName'),
      initialEditValue: '',
      hidden: false,
      width: 60,
      minWidth: 30,
    ...
    {
      field: 'duedate',
      title: t('financials.line.duedate'),
      type: 'date',
      align: 'right',
    ...
    {
      field: 'amount',
      title: t('financials.line.amount'),
      type: 'currency',
      initialEditValue: 0,
      currencySetting: {
        locale: locale,
...
export const ColumnsModule = (t, locale) => [
  ...
  {
    field: 'parent',
    title: t('module.parent'),
    type: 'string',
    export: true,
  },
  {
    field: 'enterdate',
    title: t('common.enterdate'),
    type: 'date',
    align: 'right',
    dateSetting: { locale: locale },
    export: true,
...
export const ColumnsAsset = (data, t, locale, currency) => [
  ...
  {
    field: 'oaccount',
    title: t('common.oaccount'),
    editComponent: ({ value, onRowDataChange, rowData }) =>
      OACCOUNT(data, value, onRowDataChange, rowData, 'oaccount'),
    width: 20,
    export: true,
  },
  {
...
export const ColumnsM2 = (t, locale) => [
  {
    field: 'id',
    title: t('common.id'),
    export: true,
...
export const ColumnsM = (data, t, locale) => [
  {
    field: 'id',
    title: t('common.id'),
    export: true,
...
export const ColumnsSalaryItem = (data, t, locale, currency) => [
  {
    field: 'id',
    title: t('common.id'),
    export: true,
...
export const ColumnsComp = (data, t, locale) => [
  {
    field: 'id',
    title: t('common.id'),
    export: true,
  ...
  {
    field: 'purchasingClearingAcc',
    title: t('common.purchasingClearingAcc'),
    editComponent: ({ value, onRowDataChange, rowData }) =>
      ACCOUNT(data, value, onRowDataChange, rowData, 'account'),
    width: 20,
    export: true,
  ...
  {
    field: 'salesClearingAcc',
    title: t('common.salesClearingAcc'),
    editComponent: ({ value, onRowDataChange, rowData }) =>
      ACCOUNT(data, value, onRowDataChange, rowData, 'account'),
    width: 20,
    export: true,
  ...
  {
    field: 'paymentClearingAcc',
    title: t('common.paymentClearingAcc'),
    editComponent: ({ value, onRowDataChange, rowData }) =>
      ACCOUNT(data, value, onRowDataChange, rowData, 'account'),
    width: 20,
    export: true,
  ...
  {
    field: 'settlementClearingAcc',
    title: t('common.settlementClearingAcc'),
    editComponent: ({ value, onRowDataChange, rowData }) =>
      ACCOUNT(data, value, onRowDataChange, rowData, 'account'),
    width: 20,
    export: true,
  ...
  {
    field: 'pageHeaderText',
    title: t('company.pageHeaderText'),
    type: 'text',
    export: true,
  },
  {
    field: 'pageFooterText',
    title: t('company.pageFooterText'),
    type: 'text',
    export: true,
  },
  {
    field: 'headerText',
    title: t('company.headerText'),
    type: 'text',
    export: true,
  },
  {
    field: 'footerText',
    title: t('company.footerText'),
    type: 'text',
    export: true,
  },
  {
    field: 'logoName',
    title: t('company.logoName'),
    type: 'text',
    export: true,
  },
]
export const ColumnsACC = (data, t) => [
  ...
  {
    field: 'isDebit',
    title: t('account.debit_credit'),
    type: 'boolean',
    export: true,
  },
  {
    field: 'balancesheet',
    title: t('account.balancesheet'),
    type: 'boolean',
    export: true,
  },
  {
...
export const ColumnsVAT = (data, t, locale) => [
  {
    field: 'id',
    title: t('common.id'),
    export: true,
  ...
  },
  {
    ...
    title: t('vat.input_account'),
    editComponent: ({ value, onRowDataChange, rowData }) =>
      ACCOUNT(data, value, onRowDataChange, rowData, 'inputVatAccount'),
    width: 20,
    export: true,
  },
  {
    field: 'outputVatAccount',
    title: t('vat.output_account'),
    editComponent: ({ value, onRowDataChange, rowData }) =>
      ACCOUNT(data, value, onRowDataChange, rowData, 'outputVatAccount'),
    width: 20,
    export: true,
  },
  {
...
export const ColumnsBS = (t, locale, currency) => [
  ...
  {
    field: 'depositor',
    title: t('bankstatement.depositor'),
    type: 'string',
    minWidth: 10,
    export: true,
  },
  {
    field: 'valuedate',
    title: t('bankstatement.valuedate'),
    type: 'date',
    align: ' right',
    dateSetting: { locale: locale },
    minWidth: 10,
  ...
  {
    field: 'postingtext',
    title: t('bankstatement.postingtext'),
    type: 'string',
    minWidth: 50,
    export: true,
  },
  ...
  {
    field: 'beneficiary',
    title: t('bankstatement.beneficiary'),
    type: 'string',
    minWidth: 20,
    export: true,
  },
  {
    field: 'accountno',
    title: t('bankstatement.accountno'),
    type: 'string',
    minWidth: 20,
    export: true,
  },
  {
    field: 'bankCode',
    title: t('bankstatement.bankCode'),
    type: 'string',
    minWidth: 10,
    export: true,
  },
  ...
  {
    field: 'companyIban',
    title: t('bankstatement.companyIban'),
    type: 'string',
    minWidth: 20,
    export: true,
  },
...
export const ColumnsCUST = (data, t, locale) => [
  {
    field: 'id',
    title: t('common.id'),
    type: 'numeric',
...
export const ColumnJournal = (t, locale, currency) => [
  {
    field: 'id',
    title: t('common.id'),
    width: 30,
  ...
  },
  {
    ...
    maxWidth: 60,
    type: 'date',
    format: (value) => dateFormat(value, 'dd.mm.yy'),
    export: true,
  },
  {
    field: 'period',
    title: t('journal.period'),
    minWidth: 30,
    maxWidth: 30,
    type: 'numeric',
    export: true,
  ...
  {
    field: 'text',
    title: t('journal.text'),
    minWidth: 15,
    export: true,
  },
  {
    id: 'month',
    label: t('journal.month'),
    minWidth: 20,
    maxWidth: 20,
    export: true,
  },
...
export const ColumnsBalancesheet = (t, locale, currency) => [
  {
    title: t('common.id'),
    field: 'id',
    type: 'text',
  ...
  },
  {
    ...
    render: (rowData) =>
      rowData.isDebit
        ? Number(rowData.idebit + rowData.debit - rowData.icredit - rowData.credit).toLocaleString(
            locale,
            {
              maximumFractionDigits: 2,
              minimumFractionDigits: 2,
        ...
        : Number(rowData.icredit + rowData.credit - rowData.idebit - rowData.debit).toLocaleString(
            locale,
            {
              maximumFractionDigits: 2,
              minimumFractionDigits: 2,
...
export const ColumnFactory = (formid, data, t, locale, currency) => {
  switch (formid) {
    ...
    case formEnum.BANKACCOUNT:
      return columns_BANK_ACCOUNT(data, t)
    case formEnum.EMPLOYEE_SALARY_ITEM_TABLE:
      return ColumnsEmployeeSalaryItem(data, t, locale, currency)
    ...
    case formEnum.COMPANY:
      return ColumnsComp(data, t, locale)
    case formEnum.PACB:
