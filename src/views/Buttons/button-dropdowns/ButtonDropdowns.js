        ...
        <CCard>
          ...
          <CCardBody>
            ...
            <CDropdown className="m-1">
              ...
              <CDropdownMenu>
                <CDropdownItem header onClick = {prev => setShow(!show)}>{show?"Display Table":"Display Tabs"}</CDropdownItem>
            ...
            <CDropdown className="m-1 btn-group">
              ...
              <CDropdownMenu>
                ...
                <CDropdownItem>Action</CDropdownItem>
                <CDropdownDivider />
                <CDropdownItem onClick ={event => {alert("Hello")}}>Another Action</CDropdownItem>
              </CDropdownMenu>
            </CDropdown>
            <CDropdown className="m-1 btn-group">
